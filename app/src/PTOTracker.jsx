        ...
        {[0, 1, 2, 3].map(function(i) {
          return (
            <div key={i} onClick={function(e) { e.stopPropagation(); focusInput(); }} style={{
              ...
              {digits[i] && (
                <span style={{ ...T.num, color: S.text, userSelect: 'none' }}>
                  {digits[i]}
                </span>
              )}
            </div>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: isMobile
            ...
            {panelTab === "reco" ? (function() {
              ...
              return (
                <div style={{ paddingTop: isMobile ? 28 : 40 }}>
                  {availSizes.length === 0 ? (
                    <div style={{ ...T.body.sm, color: S.textSubtle, lineHeight: 1.4 }}>No opportunities available with your current balance.</div>
                  ) : (
                    <div>
                      ...
                      <div style={{ background: S.surface, borderRadius: 16, padding: "14px 14px 20px", marginBottom: 8 }}>
                        <div style={{ ...T.body.sm, color: S.textSubtle, marginBottom: 16 }}>Days off</div>
                        {/* Numbers row */}
                        <div style={{ position: "relative", height: 26, marginBottom: 14 }}>
                          {effectiveDays > minDays && (
                            <div style={{ position: "absolute", left: 0, ...T.num, color: S.textFaint, lineHeight: 1 }}>{minDays}</div>
                          )}
                          {effectiveDays < maxDays && (
                            <div style={{ position: "absolute", right: 0, ...T.num, color: S.textFaint, lineHeight: 1 }}>{maxDays}</div>
                          )}
                          <div style={Object.assign({ position: "absolute", ...T.num, color: S.text, lineHeight: 1 }, thumbStyle)}>{effectiveDays}</div>
                        </div>
                        {/* Slider */}
                      ...
                      {currentOpps.length > 0 ? (
                            ...
                            return (
                              <div key={o.date + "-" + o.size}
                                ...
                                {(function() {
                                  ...
                                  return <div style={{ ...T.body.sm, color: S.textSubtle }}>{parts.join(", ")}</div>;
                                })()}
                              </div>
                            );
                          })}
                        ...
                        <div style={{ ...T.body.sm, color: S.textSubtle, lineHeight: 1.4 }}>No opportunities for {effectiveDays} days off.</div>
                      )}
                    </div>
                  )}
                </div>
            ...
            {panelTab === "settings" ? (
              <div style={{ paddingTop: isMobile ? 28 : 40 }}>
                ...
                <div style={{ marginBottom: 48 }}>
                  <div style={{ ...T.label.base, color: S.textSubtle, marginBottom: 12 }}>Info</div>
                  ...
                  <div style={{ display: "flex", gap: 4 }}>
                    ...
                    <div style={{ flex: 1, background: S.surface, borderRadius: 16, height: 76, padding: "0 16px", display: "flex", flexDirection: "column", justifyContent: "center", border: focusedField === "mlDate" ? "0.5px solid " + S.textSubtle : "0.5px solid transparent" }}>
                      <div style={{ ...T.label.sm, color: S.textSubtle, marginBottom: 8 }}>ML Effective Date</div>
                ...
                <div style={{ marginBottom: 48 }}>
                  ...
                  <div style={{ display: "flex", gap: 4 }}>
                    <div style={{ flex: 1, background: S.surface, borderRadius: 16, height: 76, padding: "0 16px", display: "flex", flexDirection: "column", justifyContent: "center", border: focusedField === "bal" ? "0.5px solid " + S.textSubtle : "0.5px solid transparent" }}>
                      <div style={{ ...T.label.sm, color: S.textSubtle, marginBottom: 8 }}>Hours</div>
                    ...
                    <div style={{ flex: 1, background: S.surface, borderRadius: 16, height: 76, padding: "0 16px", display: "flex", flexDirection: "column", justifyContent: "center", border: focusedField === "balDate" ? "0.5px solid " + S.textSubtle : "0.5px solid transparent" }}>
                      <div style={{ ...T.label.sm, color: S.textSubtle, marginBottom: 8 }}>As of Date</div>
              ...
              <div style={{ paddingTop: isMobile ? 28 : 40 }}>
                ...
                {writeSelectedGroups.length > 0 && writePlanGroups.length > 0 ? (
                  <div style={{ marginTop: 48 }}>
                    <div style={{ ...T.label.base, color: S.textSubtle, marginBottom: 16 }}>Text</div>
